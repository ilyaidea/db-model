...
<link rel="stylesheet" href="{{ static_url('theme/partials/head/all.min.css') }}">

<!-- dataTable -->
<link rel="stylesheet" type="text/css"
      href="{{ static_url('assets/datatables.net-dt/css/jquery.dataTables.min.css') }}">

<link rel="stylesheet"
      href="{{ static_url('assets/datatables.net/extensions/Responsive/css/responsive.dataTables.min.css') }}">
<link rel="stylesheet" type="text/css" href="{{ static_url('assets/slick-carousel/slick/slick.css') }}">
<link rel="stylesheet" type="text/css" href="{{ static_url('assets/slick-carousel/slick/slick-theme.css') }}">
